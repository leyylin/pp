        ...
        addToCartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (state.equals("Order Placed") || state.equals("Order Shipped")){
                    Toast.makeText(ProductDetailsActivity.this,"Вы можете добавить покупку дополнительного товара, как только ваш заказ будет отправлен или подтвержден",Toast.LENGTH_LONG).show();
                }
                else
                {
                    addingToCartList();
