...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(SettinsActivity.this, "Профиль успешно обновлен.", Toast.LENGTH_SHORT).show();
        finish();
    }
    ...
    private void uploadImage() {
        ...
        progressDialog.setTitle("Обновить профиль");
        progressDialog.setMessage("Пожалуйста, подождите, пока мы обновим информацию о вашей учетной записи");
