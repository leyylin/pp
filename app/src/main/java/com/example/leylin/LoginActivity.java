...
public class LoginActivity extends AppCompatActivity {
    ...
    private void LoginUser()
    {
        ...
        {
            loadingBar.setTitle("Войти в аккаунт");
                ...
                if (dataSnapshot.child(parentDbName).child(phone).exists()){
                    ...
                    if (usersData.getPhone().equals(phone))
                    {
                        if (usersData.getPassword().equals(password))
                        {
                            ...
                            {
                                Toast.makeText(LoginActivity.this, "Добро пожаловать, Администратор. Вы успешно вошли в систему...", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                                ...
                                Toast.makeText(LoginActivity.this, "Вы успешно вошли в систему...", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                    ...
                    Toast.makeText(LoginActivity.this, "Аккаунт с таким " + phone + " номером не существует.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
